...
class MusicExplorer2 extends StatefulWidget {
  const MusicExplorer2({Key? key}) : super(key: key);

  @override
  State<MusicExplorer2> createState() => _MusicExplorer2State();
}

class _MusicExplorer2State extends State<MusicExplorer2> {
                    ...
                    if (snapshot.hasData) {
                      ...
                      return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return InkWell(
                              onLongPress: () {
                                selectedSongs.add(organizedFiles[index].path);
                              },
                              child: Card(
                                child: Obx(() {
                                  return CheckboxListTile(
                                      value: selectedSongs
                                          .contains(organizedFiles[index].path),
                                      title: Text(
                                          Utilities.basename(
